...
class TravelPredictorService:
    ...
    def get_recommendations(self, user_profile: Dict[str, Any], top_k: int = 5) -> Dict[str, Any]:
        ...
        try:
            ...
            # Make prediction using AIModel-v13.py only
            if self.predictor is None:
                return {
                    "error": "Model not loaded. Please ensure the model is properly trained and saved.",
                    "status": "error"
                }
    ...
    def health_check(self) -> Dict[str, Any]:
        ...
        return {
            "status": "healthy" if self.is_loaded and self.predictor is not None else "not_ready",
